...
But in addition, Keras can now make use of built-in TensorFlow functionality, which wasn't possible before. For example, you can take your 1:1 Keras code and TensorFlow will scale it to a large GPU or TPU cluster. We'll have a look at this in the next chapter.

For now, just follow along with the video and code exercise below to get an idea of how things work:
